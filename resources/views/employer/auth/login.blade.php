...
@section('content')
    ...
    <div class="w-100" style="max-width:420px">
        <div class="text-center text-white mb-4">
            ...
            @endif
            <p class="mb-0 opacity-75 small">Employer</p>
        </div>

        <div class="card auth-card">
            <div class="card-body p-4 p-sm-5">
                <h2 class="h5 fw-semibold mb-1">Sign in</h2>
                <p class="text-secondary small mb-4">Enter your credentials to access your employer account.</p>
                ...
                <p class="text-center small text-secondary mt-4 mb-0">
                    New here?
                    <a href="{{ route('employer.register') }}" class="text-brand fw-semibold">Create an employer account</a>
                </p>
            </div>
        </div>
        ...
        <p class="text-center text-white-50 small mt-4 mb-0">
            Looking for a job?
            <a href="{{ route('candidate.login') }}" class="text-white">Candidate sign in</a>
        </p>
    </div>
@endsection
