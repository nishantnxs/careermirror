...
<section class="employer-panel">
    <div class="container">
        <div class="mb-4">
            <a href="{{ route('employer.orders.index') }}" class="back-link">
                <i class="fa-solid fa-arrow-left me-1"></i> Back to orders
            </a>
            <h1 class="panel-title mt-2">{{ $order->order_number }}</h1>
            <p class="panel-subtitle">Payment and subscription details for this purchase.</p>
        </div>

        <div class="row g-4">
            <div class="col-lg-7">
                <div class="panel-card mb-4">
                    <div class="panel-card-header">Order</div>
                ...
                @if ($order->subscription)
                    <div class="panel-card">
                        <div class="panel-card-header">Subscription</div>
                        <div class="panel-card-body">
                            <dl class="row mb-0">
            ...
            <div class="col-lg-5">
                <div class="panel-card">
                    <div class="panel-card-header">Payment audit trail</div>
                    <div class="panel-card-body">
                        <dl class="row mb-0">
                                ...
                                <dd class="col-7">
                                    <ul class="list-unstyled small mb-0">
                                        @foreach ($order->payment_meta as $key => $value)
                                            <li>
                                                <span class="text-secondary">{{ str_replace('_', ' ', $key) }}:</span>
